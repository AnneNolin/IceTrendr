...
diagfile = ["/projectnb/trenders/scenes/046029/outputs/nbr/IT_v2.00_nbr_046029_paramset01_20130125_164800_diag.sav"] ;full path to dia.sav files - can include multiple files, use a comma to separate them
