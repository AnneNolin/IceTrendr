...
useareafile = "/projectnb/trenders/scenes/gnn_snapped_cmon_usearea_files/045029_usearea.bsq" ; full path to a 0-1 raster that defines where Icetrendr will be run :: zeros = don't run, ones = run 
segparamstxt = "/projectnb/trenders/helperfiles/cmonster_nbr_segmentation_parameters.txt" ;give full path to the segmentation parameter .txt file
...
segmentation_eval    = 0  ;runs icetrendr in evaluation mode
segmentation         = 1  ;creates segmentation outputs
fit_to_vertices      = 1  ;use 1 to run bgw, 2 to run b5,b4,b3, 3 to run both
