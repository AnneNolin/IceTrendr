...
B5_STRETCH = [0.1, 0.15, 0.4, 0.11]
B4_STRETCH = [0.1, 0.23, 0.4, 0.2]
B2_STRETCH = [0.1, 0.20, 0.4, 0.26]
...
def create_chip(spectral_file, x, y, width, height, chip_file):
    ...
    #read Bands 5, 4, 2
    b5 = read_spectral(spectral_file, x, y, width, height, 5)/10000.
    b4 = read_spectral(spectral_file, x, y, width, height, 4)/10000.
    b2 = read_spectral(spectral_file, x, y, width, height, 2)/10000.

    save_chip(b5, b4, b2,
              B5_STRETCH, B4_STRETCH, B2_STRETCH,
              chip_file)
...
def harvest_chip(tsa, sample_file, image_list_file, chip_dir, project_id):
	...
	this_plot = this_sample[2]
	    ...
	    #import pdb ; pdb.set_trace()
            ...
            create_chip(refl, this_x, this_y, 255, 255, chip_file)
