    ...
    'nextyear': begin
      ...
      if n_dontdoit ge 1 then begin
        ...
        if tellitok eq 'Yes' then begin
          ...
          delete_it_files, info.path, info.ppprrr, strcompress(yearday, /rem), /nowarning
...
pro screenimg_gui_testing, path, ppprrr
  ...
  base = widget_base(column=1, group_leader=leader, /modal, title='IceTrendr Screen Images')
