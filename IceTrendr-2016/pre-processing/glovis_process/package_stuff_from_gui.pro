pro package_stuff_from_gui, status
  ...
  ;pack up the info in a strcuture for icetrendr_processor.pro
  run_params = {ppprrr:ppprrr,$
    ...
    it_convert_glovis:status.progrp1boxf,$
    ...
    vct_to_it_masks:status.progrp1boxg,$
    ...
    delete_it_dates:status.progrp7boxg,$
  ...
  icetrendr_preprocessor, run_params
