pro icetrendr_gui_event, event

  widget_control, event.top, get_uvalue=infoptr
  info = *infoptr
  
  widget_control, event.id, get_uvalue=selected
  common icetrendr, status
  case selected of
    ;runfile
    'runfile': begin
      filename = dialog_pickfile()
      if filename eq '' then status.path = 'No IceTrendr Run File Selected' else status.path = filename
      if status.path ne 'No IceTrendr Run File Selected' then widget_control, info.file, set_value=file_basename(filename) $
    ...
    'runthething': begin
      ...
      if selectedfile eq 'No IceTrendr Run File Selected' then ok = dialog_message('No IceTrendr Run File Was Selected.') else begin
    ...
    ;help buttons
    'icetrendr1': it_gui_help_menu, 'icetrendr1'
    'icetrendr2': it_gui_help_menu, 'icetrendr2'
    'icetrendr3': it_gui_help_menu, 'icetrendr3'
    'icetrendr4': it_gui_help_menu, 'icetrendr4'
    'aboutgrp1': it_gui_help_menu, 'aboutgrp1'
    'aboutgrp2': it_gui_help_menu, 'aboutgrp2'
    'aboutgrp3': it_gui_help_menu, 'aboutgrp3'
    'aboutgrp4': it_gui_help_menu, 'aboutgrp4'
    'aboutgrp5': it_gui_help_menu, 'aboutgrp5'
    'aboutgrp6': it_gui_help_menu, 'aboutgrp6'
    'aboutgrp7': it_gui_help_menu, 'aboutgrp7'
    'progrp1helpa': it_gui_help_menu, 'progrp1helpa'
    'progrp1helpb': it_gui_help_menu, 'progrp1helpb'
    'progrp1helpc': it_gui_help_menu, 'progrp1helpc'
    'progrp1helpd': it_gui_help_menu, 'progrp1helpd'
    'progrp1helpe': it_gui_help_menu, 'progrp1helpe'
    'progrp1helpf': it_gui_help_menu, 'progrp1helpf'
    'progrp1helpg': it_gui_help_menu, 'progrp1helpg'
    'progrp2helpa': it_gui_help_menu, 'progrp2helpa'
    'progrp3helpa': it_gui_help_menu, 'progrp3helpa'
    'progrp3helpb': it_gui_help_menu, 'progrp3helpb'
    'progrp4helpa': it_gui_help_menu, 'progrp4helpa'
    'progrp4helpb': it_gui_help_menu, 'progrp4helpb'
    'progrp5helpa': it_gui_help_menu, 'progrp5helpa'
    'progrp6helpa': it_gui_help_menu, 'progrp6helpa'
    'progrp6helpb': it_gui_help_menu, 'progrp6helpb'
    'progrp6helpc': it_gui_help_menu, 'progrp6helpc'
    'progrp6helpd': it_gui_help_menu, 'progrp6helpd'
    'progrp7helpa': it_gui_help_menu, 'progrp7helpa'
    'progrp7helpb': it_gui_help_menu, 'progrp7helpb'
    'progrp7helpc': it_gui_help_menu, 'progrp7helpc'
    'progrp7helpd': it_gui_help_menu, 'progrp7helpd'
    'progrp7helpe': it_gui_help_menu, 'progrp7helpe'
    'progrp7helpf': it_gui_help_menu, 'progrp7helpf'
    'progrp7helpg': it_gui_help_menu, 'progrp7helpg'
    'progrp7helph': it_gui_help_menu, 'progrp7helph'
    'fixthesehelp': it_gui_help_menu, 'fixthesehelp'
    'deletethesehelp': it_gui_help_menu, 'deletethesehelp'
  endcase
...
pro icetrendr_gui, info
  common icetrendr, status
  status = {path:'No IceTrendr Run File Selected' ,$
  ...
  frame = 583
  base = widget_base(column=1, mbar=mbar, title='IceTrendr Processor')  ;, /scroll, x_scroll_size=20, y_scroll_size=20
  ...
  icetrendr1 = widget_button(fbase, value='What is IceTrendr (IT)?', uvalue='icetrendr1')  ;
  icetrendr2 = widget_button(fbase, value='About IT Processing', uvalue='icetrendr2')  ;
  ;icetrendr3 = widget_button(fbase, value='About IT Segmentation', uvalue='icetrendr3')  ;, /align_right
  icetrendr4 = widget_button(fbase, value='About IT Landscape History Outputs', uvalue='icetrendr4')  ;, /align_right
  
  runfileb = widget_base(topstuff, column=1)
  runfile = widget_button(runfileb, value='Browse for IceTrendr Run File', uvalue='runfile', xsize=572, ysize=40)
  file = widget_text(topstuff, value='No IceTrendr Run File Selected', uvalue='file')
  ...
  progrp1boxf = widget_button(progrp1checkbox, value='IT Prepare GLOVIS Images', uvalue='progrp1boxf')
  progrp1boxg = widget_button(progrp1checkbox, value='Convert VCT Masks to IT Masks', uvalue='progrp1boxg')
  ...
  runthething = widget_button(startbase, value='Run IceTrendr Procedure(s)', uvalue='runthething', xsize=280, ysize=76)
  ...
  xmanager, 'icetrendr_gui', base, /no_block
