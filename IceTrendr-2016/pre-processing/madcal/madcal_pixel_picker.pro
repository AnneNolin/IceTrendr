...
pro madcal_pixel_picker, path, this_run_info, image_info, param_set=param_set, modis_ref=modis_ref,$
  ...
  ;reffile = "L:/4626/images/1992/IT4046026_1992_231_radref.bsq"
  ;depfile = "L:/4626/images/1985/IT5046026_1985_235_archv.bsq"
  ;maskref = "L:/4626/images/1992/IT4046026_1992_231_madcal_mask.bsq"
  ;maskdep = "L:/4626/images/1985/IT5046026_1985_235_madcal_mask.bsq"
  ;usearea = "L:/4626/study_area/046026_vct_usearea.bsq"
  ;imageinfo = "L:/4626/images/icetrendr_image_info_046026.sav"
...
;  write_im_hdr, outimg, maskdep_hdr
  ...
  repeat begin ;cycle through the bins doing grabs until all of the bins have a set amount of no change pixels
    ...
    if nochangecount eq 0 then begin
      ...
      print, ">>> then delete the date - use the 'delete_it_dates' process in the batchfile - note that..."
