package org.larse.tsclass
{
	public class SpectralBands
	{
		...
		public function get b3b5():Number {
			return (b3/b5);
		}
		
		public function get doy():Number {
			return (julday);
		}

		public function get turb():Number {
			return (-0.441 + 0.0340*b3 + 0.0597*b4);
			//return (Math.pow(10, -0.441 + 0.0340*b3 + 0.0597*b4));
		}

		public function get ndsi():Number {
			if (sensor == SpectralBands.MSS)
				return 0;
			if ((b2+b5)==0)
				return -99;
			return int((b2-b5)/(b2+b5)*100)/100;
		}
		...
		public function getSpectral(ax:String):Number {
			...
			switch (ax) {
				...
				case SpectralIndex.NBR:
					val = nbr;
					break;
				case SpectralIndex.NDSI:
					val = ndsi;
					break;
				case SpectralIndex.B3B5:
					val = b3b5;
					break;
				case SpectralIndex.DOY:
					val = doy;
					break;
				case SpectralIndex.TURB:
					val = turb;
					break;
				default:
					val = -9999;
		...
		public function SpectralBands(b1:Number=0, b2:Number=0, b3:Number=0,
									  ...
									  sensor:String="tm", julday:Number=1)
		{
			this.sensor = sensor;
			this.b1 = b1;
			this.b2 = b2;
