package org.larse.tsclass
{
	...
	public class PlotSpectral
	{
									 ...
									 b:Number, g:Number, w:Number)
		{
			...
			_year = year;
			_julday = julday;
			_spectralBands = new SpectralBands(b1, b2, b3, b4, b5, b7, b, g, w, sensor, julday);
			_sequence = -1;
		}
...
//--------------------------------------------------------------
		...
		public function get ndsi():Number {
			return _spectralBands.ndsi;
		}
		
		public function get b3b5():Number {
			return _spectralBands.b3b5;
		}
		public function get doy():Number {
			return _spectralBands.doy;
		}
		public function get turb():Number {
			return _spectralBands.turb;
		}
