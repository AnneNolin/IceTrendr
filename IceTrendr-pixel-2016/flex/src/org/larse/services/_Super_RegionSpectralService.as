...
internal class _Super_RegionSpectralService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{
    ...
    public function _Super_RegionSpectralService()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "getRegionSpectralForYear");
        operation.resultElementType = org.larse.vos.RegionSpectral;
        operations["getRegionSpectralForYear"] = operation;
    ...
    /**
      * This method is a generated wrapper used to call the 'getRegionSpectralForYear' operation. It returns an mx.rpc.AsyncToken whose
      * result property will be populated with the result of the operation when the server response is received.
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value.
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function getRegionSpectralForYear(project_id:int, tsa:int, plotid:int, year:int) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("getRegionSpectralForYear");
