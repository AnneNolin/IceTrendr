...
internal class _RegionSpectralEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("tcg", "tsa", "target_day", "image_julday", "plotid", "b3", "b2", "b5", "b4", "tcb", "b7", "sensor", "selected", "tcw", "image_year", "project_id", "b1", "spectral_scaler", "cloud_cover", "cloud");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("tcg", "tsa", "target_day", "image_julday", "plotid", "b3", "b2", "b5", "b4", "tcb", "b7", "sensor", "selected", "tcw", "image_year", "project_id", "b1", "spectral_scaler", "cloud_cover", "cloud");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("tcg", "tsa", "target_day", "image_julday", "plotid", "b3", "b2", "b5", "b4", "tcb", "b7", "sensor", "selected", "tcw", "image_year", "project_id", "b1", "spectral_scaler", "cloud_cover", "cloud");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("tcg", "tsa", "target_day", "image_julday", "plotid", "b3", "b2", "b5", "b4", "tcb", "b7", "sensor", "selected", "tcw", "image_year", "project_id", "b1", "spectral_scaler", "cloud_cover", "cloud");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("tcg", "tsa", "target_day", "image_julday", "plotid", "b3", "b2", "b5", "b4", "tcb", "b7", "sensor", "selected", "tcw", "image_year", "project_id", "b1", "spectral_scaler", "cloud_cover", "cloud");
    ...
    public function _RegionSpectralEntityMetadata(value : _Super_RegionSpectral)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["cloud"] = new Array();
        ...
        model_internal::propertyTypeMap["cloud"] = "int";
    ...
    [Bindable(event="propertyChange")]   
    public function get cloudStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
