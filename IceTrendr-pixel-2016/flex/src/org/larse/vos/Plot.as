...
//------------------------------------------------------------	
	...
	public static const UNCERTAINTY_LDLC:uint = 8;
	public static const UNCERTAINTY_DTLC:uint = 16;
	...
	private var disturbances:Array = new Array("Stable", "Glacier Retreat", "Glacier Advance", "Albedo Increase", "Albedo Decrease", "Debris Flow", "Water - Glacier Flood", "Water - Fluvial Changes", "Water - Supraglacial", "Vegetation Growth", "Other");
